    ...
    if (
      ...
      try {
        ...
        if (!$adminExists) {
          ...
          if (password_verify($_POST['password'], $adminExists['password'])) {
            setcookie('adminLoggedin', true, time() + 3600, '/');
            setcookie('adminFirstname', $adminExists['firstName'], time() + 3600, '/');
            setcookie('adminLastname', $adminExists['lastName'], time() + 3600, '/');
            setcookie('idAdmin', $adminExists['idAdmin'], time() + 3600, '/');
